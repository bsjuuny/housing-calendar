...
export default async function IndexPage() {
  ...
  return (
    <>
      {/* Header Hero Section - Hidden on Mobile via both Tailwind and inline style for safety */}
      <section
        className="hidden lg:block mb-12 max-w-7xl mx-auto px-2"
      >
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="flex-1 space-y-4">
            ...
            <h1 className="text-7xl font-black text-white tracking-tighter leading-none shrink-0">
              METROPOLITAN <br />
          ...
          <div className="flex bg-slate-900/40 border border-white/5 rounded-[2rem] p-1 backdrop-blur-3xl shadow-2xl min-w-[300px]">
            <div className="flex-1 px-6 py-4 border-r border-white/5 flex flex-col items-center justify-center">
              <span className="text-2xl font-black text-white tracking-tight">{subscriptions.length}</span>
      ...
      <footer className="hidden lg:block mt-20 text-center pb-10">
